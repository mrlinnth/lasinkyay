...
use Mrlinnth\Lasinkyay\Exceptions\InvalidPlanFeatureException;
...
class Plan extends Model implements PlanInterface
{
    ...
    {
        return $this->hasMany(config('lasinkyay.models.plan_feature'));
    }
    ...
    {
        return $this->hasMany(config('lasinkyay.models.plan_subscription'));
    }
    ...
    {
        return trans_choice('lasinkyay::messages.interval_description.' . $this->interval, $this->interval_count);
    }
